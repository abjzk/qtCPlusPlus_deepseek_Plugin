...
class DeepSeekanalysisPlugin_EXPORT DeepSeekPlugin : public AbstractPlugin
{
    Q_OBJECT
public:
...
class DeepSeekanalysisPlugin_EXPORT DeepSeekPluginFactory : public QObject, public PluginFactory
{
    Q_OBJECT
