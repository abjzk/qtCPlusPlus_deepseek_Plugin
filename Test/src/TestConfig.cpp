...
void TestConfig::writeConfig()
{
    ...
    bool writeResult1 = config->write("DateTime", newDateTime);
    ...
    config->registerConfig("String", "名称", TConfig::Type::String, "test");
    bool writeResult5 = config->write("String", emptyString);
    ...
    bool writeResult6 = config->write("String", nullValue);
