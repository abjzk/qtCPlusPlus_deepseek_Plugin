    ...
    : LBaseTitleBar(parent)
{
    ...
    /*自动缩放的占位符*/
    QSpacerItem *spacerItem = new QSpacerItem(30, 30, QSizePolicy::Expanding, QSizePolicy::Minimum);

    // 再添加一个占位符，使得搜索框居中
    QSpacerItem *spacerItem2 = new QSpacerItem(30, 30, QSizePolicy::Expanding, QSizePolicy::Minimum);
    ...
    this->minButton->setFixedSize(this->buttonSize, this->buttonSize);
    ...
    this->maxButton->setFixedSize(this->buttonSize, this->buttonSize);
    ...
    this->closeButton->setFixedSize(this->buttonSize, this->buttonSize);
...
void LTitleBar::paintEvent(QPaintEvent *event)
{
    ...
    // 绘制icon,大小为30，30
    painter.drawPixmap(2, 2, 30, 30, this->icon.pixmap(30, 30));
    // 字体大小
    QFont font;
...
void LWidget::setTitleBar(LBaseTitleBar *titleBar)
{
    ...
    this->_titleBar->setFixedHeight(45);	   // 设置标题栏高度
